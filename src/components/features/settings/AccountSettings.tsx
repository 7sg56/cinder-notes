            ...
            <div className="max-w-4xl mx-auto space-y-10">
                ...
                <div className="flex items-center justify-between pb-6 border-b border-[var(--border-primary)]">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-[var(--text-secondary)]">Manage your profile and security preferences</p>
                    </div>
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <button className="text-sm font-medium text-[var(--editor-header-accent)] hover:underline">Change avatar</button>
                            <p className="text-xs text-[var(--text-tertiary)] mt-1">JPG, GIF or PNG. Max size of 800K</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Globe className="absolute left-3 top-2.5 text-[var(--text-tertiary)]" size={16} />
                                <input
                                    ref={emailRef}
                                    type="email"
                ...
                <div className="space-y-4 pt-6 border-t border-[var(--border-primary)]">
                    ...
                    <div className="space-y-3">
                        {[
                            { icon: KeyRound, title: "Password", desc: "Last changed 3 months ago", action: "Update" },
                            { icon: Shield, title: "Two-Factor Authentication", desc: "Currently disabled", action: "Enable" }
                        ].map((item, idx) => (
