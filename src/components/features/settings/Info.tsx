            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="flex items-center justify-between pb-6 border-b border-[var(--border-primary)]">
                    <div className="flex items-center gap-4">
                        <div className="p-3 bg-[var(--bg-secondary)] rounded-2xl border border-[var(--border-primary)] shadow-sm">
                            <InfoIcon size={28} className="text-[var(--editor-header-accent)]" />
                        </div>
                        <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-6">
                        <section>
                            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">What is Cinder?</h2>
                            <p className="text-[var(--text-secondary)] leading-relaxed text-sm">
                                Cinder Notes is a high-performance markdown editor designed for speed and focus.
                                Built with a "less is more" philosophy, it provides a clean canvas for your thoughts
                                while keeping powerful tools just a click away in the Floating Hub.
                            </p>
                        </section>

                        <section>
                            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">Core Philosophy</h2>
                        ...
                        <div className="p-6 bg-[var(--bg-secondary)] rounded-2xl border border-[var(--border-primary)] space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <ExternalLink size={14} className="opacity-0 group-hover:opacity-100 text-[var(--text-tertiary)] transition-opacity" />
                                </a>
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <ExternalLink size={18} className="text-[var(--text-secondary)]" />
                                        <span className="text-sm font-medium text-[var(--text-primary)]">Documentation</span>
                                    </div>
                                    <ExternalLink size={14} className="opacity-0 group-hover:opacity-100 text-[var(--text-tertiary)] transition-opacity" />
                                </a>
                            </div>
